...
//搜尋折價券
$couponId = $orders[0]['coupon_discount'];
$strSQL = "SELECT * FROM `coupon` WHERE `id` = '$couponId'";
$couponData = $db->Execute($strSQL);
?>
<!DOCTYPE html>
<html lang="zh-TW">
<head>
...
<body>
	...
	<div class="l-container">
		<header class="l-header">
			<h1 class="c-pagetitle c-pagetitle--s1 l-pagetitle"><span>我的購物車</span></h1>
		</header>
		<main class="l-main">
			<!-- step -->
			<ul class="c-step_hasPhoto">
				<li class="is-active"><a href="#"><i><img src="images/icon/icon-checklist.png"
					 srcset="images/icon/icon-checklist@2x.png 2x,
								 images/icon/icon-checklist@3x.png 3x"
					 class="icon-checklist"></i><span>確認購買清單</span></a></li>
				<li class="is-active"><a href="#"><i><img src="images/icon/icon-penicel.png"
					 srcset="images/icon/icon-penicel@2x.png 2x,
								 images/icon/icon-penicel@3x.png 3x"
					 class="icon-penicel"></i><span>確認付款方式</span></a></li>
				<li class="is-active"><a href="#"><i><img src="images/icon/icon-ok.png"
					 srcset="images/icon/icon-ok@2x.png 2x,
								 images/icon/icon-ok@3x.png 3x"
					 class="icon-ok"></i><span>確認購買</span></a></li>
			</ul>
			...
			<div class="thanks">
				...
				<?php endif; ?>
				<p>
					愛倍多絕不會主動以電話或簡訊通知顧客變更付款方式!<br/>
					如接獲任何電話號碼之來電,要求變更付款方式或ATM任何操作等,請不要理會該通電話!
				</p>
			</div>
			...
			<div class="c-total">
				...
				<div class="c-total__tr">
					<span class="c-total__th">折扣金額</span>
					<span class="c-total__td" id="coupon_amount_show">NT.-<?=$couponData[0]['amount']?></span>
				</div>
			...
			<div class="l-control l-control--single text-center">
				...
				<!-- 請輸入金額<input type="text" name="amount" value="1"><br>   -->
					...
					<?php if ($orders[0]['payment'] == '信用卡付款' && $orders[0]['pay_state'] == 0) { ?>
						...
						<input type="submit" value="立即付款" class="c-btn c-btn--s2">
					<?php } ?>
				</form>
